...
output "module_values" {
  ...
  value       = module.alloydb_primary
  sensitive   = true
}


output "primary_instance_ip" {
  value = module.alloydb_primary.primary_instance.ip_address
}

output "public_ip_address" {
  value = module.alloydb_primary.primary_instance.public_ip_address
}


# output "replica_instance_ip" {
#   value = google_alloydb_instance.replica_instance[0].ip_address
# }
