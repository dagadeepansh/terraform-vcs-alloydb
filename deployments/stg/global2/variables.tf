...
variable "cluster_replica_user" {
  type        = string
  description = "The initial user for the replica cluster."
  default     = "postgres"
}
...
variable "replica_secret_id" {
  description = "The ID of the replica clusters' secret in DB"
  type        = string
  default     = "postgres_secret"
}

variable "primary_secret_id" {
  description = "The ID of the primary clusters' secret in DB"
  type        = string
  default     = "postgres_secret"
}