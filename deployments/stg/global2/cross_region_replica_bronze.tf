...
module "alloydb_replica_bronze" {
  ...
  primary_instance = {
    ...
    display_name = "Replica Instance bronze (us-central1) "
  ...
  secret_id            = "replica_postgres_secret"
}
